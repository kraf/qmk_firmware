...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_Z,              ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_GRV,            KC_BSLS,           KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,
  KC_ESC,            KC_TAB,            KC_LGUI,           KC_ESC,            LT(U_NAV,KC_SPC),  KC_TAB,            LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), KC_DEL,            KC_MINS,           KC_QUOT,           KC_ENT ),
  ...
  KC_NO,             KC_ALGR,           DF(U_NUM),         DF(U_NAV),         KC_NO,             KC_GRV,            KC_BSLS,           KC_NO,             KC_NO,             KC_NO,             KC_NO,             KC_NO,
  KC_NO,             KC_NO,             KC_LGUI,           KC_NO,             KC_NO,             KC_NO,             KC_ENT,            KC_BSPC,           KC_DEL,            KC_MINS,           KC_NO,             KC_NO),
  ...
  KC_GRV,            KC_1,              KC_2,              KC_3,              KC_BSLS,           KC_GRV,            KC_BSLS,           KC_NO,             KC_NO,             KC_NO,             KC_ALGR,           KC_NO,
  ...
  KC_TILD,           KC_EXLM,           KC_AT,             KC_HASH,           KC_PIPE,           KC_GRV,            KC_BSLS,           KC_NO,             KC_NO,             KC_NO,             KC_ALGR,           KC_NO,
